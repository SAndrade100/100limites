...
export default function Treinos() {
  ...
  const handleStartWorkout = () => {
    setShowModal(false);
    if (selectedWorkout) {
      // Navega para a tela de treino ativo com o ID do treino
      router.push(`/treino-ativo/${selectedWorkout.id}` as any);
    }
  };
